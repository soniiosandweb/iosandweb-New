...
const TabSection = () => {
  ...
  IDE: [
    ...
    return (
        <div className='TabSectionSection black section-padding no-top-padding'>
         <Container>
            <Row>
                <Col>
                <div className='TabSection textaliginCenter '>
                    <h1 className='heading_main split'>Modern, Secure & Scalable Technologies</h1>
                    <p className='FontSize18'>We leverage the latest tool and framework to ensure high performance.</p>
