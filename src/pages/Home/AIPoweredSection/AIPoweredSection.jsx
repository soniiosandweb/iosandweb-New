...
const technology = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/technology.svg`;
const trending = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/trending.svg`;
const customerService = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/customer-service.svg`;
const seo = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/seo.svg`;
const softwareDevelopment = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/software-development.svg`;
const communicationSkills = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/communication-skills.svg`;
const machineLearning = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/machine-learning.svg`;
const chatbot = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/chatbot.svg`;
const projectTeam = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/project-team.svg`;
const digitalTransformation = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/digital-transformation.svg`;
const appStore = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/app-store.svg`;
const android = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/android.svg`;
const fluter = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/fluter.svg`;
const native = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/native.svg`;
const PWA = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/pwa.svg`;
const encrypted = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/encrypted.svg`;
const smartContract = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/smart-contract.svg`;
const decentralized = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/decentralized.svg`;
const planning = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/planning.svg`;
const office = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/office.svg`;
const uxDesign = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/ux-design.svg`;
const promotion = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/promotion.svg`;
const investment = `${process.env.REACT_APP_API_URL}/assests/images/home/aiPowered/investment.svg`;
