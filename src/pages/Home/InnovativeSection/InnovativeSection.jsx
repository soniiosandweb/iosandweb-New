        ...
        <div className="innovative_section section-padding bg-black text-white">
          {!IsMobile  &&  <img src={innovativeBg} alt="Innovative IosAndWeb Technology" className="innovativeBG" />}
            <Container>
                <Row>
                    <Col>
                    {!IsMobile ?<h2 className="heading_main">Innovative IosAndWeb Technology Solutions</h2>:<h2 className="heading_main split">Innovative IosAndWeb Technology Solutions</h2>}
